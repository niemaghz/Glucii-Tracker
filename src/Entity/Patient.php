...
class Patient implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=PatientSuivi::class, mappedBy="patient")
     */
    private $insuline;
    ...
    /**
     * @return Collection|PatientSuivi[]
     */
    ...
    public function addInsuline(PatientSuivi $insuline): self
    {
    ...
    public function removeInsuline(PatientSuivi $insuline): self
    {
